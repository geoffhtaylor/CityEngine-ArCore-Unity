...
namespace GoogleARCore.Examples.CityEngineARTemplate
{
    ...
    public class ARSceneUIController : MonoBehaviour
    {
        ...
        /// <summary>
        /// Existing Conditions Button for toggling model
        /// </summary>
        public Button ExistingConditionsButton;
        ...
        public void Start()
        {
            IPAddressText.text = "IP Address: " + _GetDeviceIpAddress();
        }

        /// <summary>
        /// Shows UI for Existing Conditions and Scenario Buttons
        /// </summary>
        public void ShowCurrentScenarioText(string scenarioName)
        {
            SnackbarText.text =  scenarioName + " Selected";
        }
